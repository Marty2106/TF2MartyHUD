"Resource/UI/StorePage.res"
{
	"StorePage"
	{
		...
		"item_panel_bgcolor_mouseover"	"147 147 147 255"
		"item_panel_bgcolor_selected"	"167 167 167 255"
		"classicon_xdelta"		"5"
		"modelpanels_kv"
		{
	...
	"SubcategoryFilterComboBox"
	{
		...
		"Button"
		{
			"border_default"	"DbBlack"
			"border_armed"		"DbBlack"
			"defaultBgColor_override"	"DcGrey"
			"armedBgColor_override"	"DcBlue"
			"paintbackground"	"1"
			"defaultFgColor_override" "DcWhite"
			"armedFgColor_override" "DcGreyDark"
	...
	"StartExplanation"
	{
		...
		"CloseButton"
		{
			...
			"armedFgColor_override" "DcEmphasis"
			"depressedFgColor_override" "DcDialogBack"
			"image_drawcolor"	"117 107 94 255"
			"image_armedcolor"	"DcEmphasis"
			"SubImage"
			{
				"ControlName"	"ImagePanel"
				"fieldName"		"SubImage"
